...
class VANIEKnowledgeBase:
    ...
    def get_search_suggestions_data():
        """Search suggestions data for frontend"""
        return {
            'chats': [
                {'text': 'hello', 'icon': 'fas fa-comment', 'action': 'search'},
                {'text': 'namaste', 'icon': 'fas fa-comment', 'action': 'search'},
                {'text': 'how are you', 'icon': 'fas fa-comment', 'action': 'search'},
                {'text': 'what is vanie', 'icon': 'fas fa-comment', 'action': 'search'},
                {'text': 'coding help', 'icon': 'fas fa-code', 'action': 'search'},
                {'text': 'python tutorial', 'icon': 'fas fa-code', 'action': 'search'},
                {'text': 'javascript help', 'icon': 'fas fa-code', 'action': 'search'},
                {'text': 'quantum physics', 'icon': 'fas fa-atom', 'action': 'search'},
                {'text': 'math problem', 'icon': 'fas fa-calculator', 'action': 'search'},
                {'text': 'history question', 'icon': 'fas fa-book', 'action': 'search'},
                {'text': 'science explanation', 'icon': 'fas fa-flask', 'action': 'search'},
                {'text': 'algorithm help', 'icon': 'fas fa-project-diagram', 'action': 'search'}
            ],
            'settings': [
                {'text': 'dark mode', 'icon': 'fas fa-moon', 'action': 'setting'},
                {'text': 'light mode', 'icon': 'fas fa-sun', 'action': 'setting'},
                {'text': 'font size', 'icon': 'fas fa-text-height', 'action': 'setting'},
                {'text': 'language', 'icon': 'fas fa-language', 'action': 'setting'},
                {'text': 'voice settings', 'icon': 'fas fa-microphone', 'action': 'setting'},
                {'text': 'sound effects', 'icon': 'fas fa-volume-up', 'action': 'setting'},
                {'text': 'notifications', 'icon': 'fas fa-bell', 'action': 'setting'},
                {'text': 'theme settings', 'icon': 'fas fa-palette', 'action': 'setting'},
                {'text': 'voice language', 'icon': 'fas fa-globe', 'action': 'setting'}
            ],
            'options': [
                {'text': 'export chat', 'icon': 'fas fa-download', 'action': 'option'},
                {'text': 'clear history', 'icon': 'fas fa-trash', 'action': 'option'},
                {'text': 'search chat', 'icon': 'fas fa-search', 'action': 'option'},
                {'text': 'voice input', 'icon': 'fas fa-microphone', 'action': 'option'},
                {'text': 'file upload', 'icon': 'fas fa-paperclip', 'action': 'option'},
                {'text': 'user account', 'icon': 'fas fa-user', 'action': 'option'},
                {'text': 'logout', 'icon': 'fas fa-sign-out-alt', 'action': 'option'},
                {'text': 'login', 'icon': 'fas fa-sign-in-alt', 'action': 'option'},
                {'text': 'signup', 'icon': 'fas fa-user-plus', 'action': 'option'}
            ],
            'features': [
                {'text': 'voice typing', 'icon': 'fas fa-microphone', 'action': 'feature'},
                {'text': 'file sharing', 'icon': 'fas fa-file', 'action': 'feature'},
                {'text': 'authentication', 'icon': 'fas fa-user-lock', 'action': 'feature'},
                {'text': 'chat history', 'icon': 'fas fa-history', 'action': 'feature'},
                {'text': 'smart suggestions', 'icon': 'fas fa-lightbulb', 'action': 'feature'},
                {'text': 'multi-language', 'icon': 'fas fa-globe', 'action': 'feature'},
                {'text': 'real-time search', 'icon': 'fas fa-search', 'action': 'feature'},
                {'text': 'export functionality', 'icon': 'fas fa-file-export', 'action': 'feature'},
                {'text': 'secure login', 'icon': 'fas fa-shield-alt', 'action': 'feature'},
                {'text': 'voice commands', 'icon': 'fas fa-microphone-alt', 'action': 'feature'}
            ],
            'commands': [
                {'text': '/help', 'icon': 'fas fa-question-circle', 'action': 'command'},
                {'text': '/clear', 'icon': 'fas fa-eraser', 'action': 'command'},
                {'text': '/export', 'icon': 'fas fa-file-export', 'action': 'command'},
                {'text': '/settings', 'icon': 'fas fa-cog', 'action': 'command'},
                {'text': '/login', 'icon': 'fas fa-sign-in-alt', 'action': 'command'},
                {'text': '/logout', 'icon': 'fas fa-sign-out-alt', 'action': 'command'},
                {'text': '/voice', 'icon': 'fas fa-microphone', 'action': 'command'},
                {'text': '/search', 'icon': 'fas fa-search', 'action': 'command'}
            ],
            'shortcuts': [
                {'text': 'Ctrl+K - Quick search', 'icon': 'fas fa-keyboard', 'action': 'shortcut'},
                {'text': 'Ctrl+M - Voice input', 'icon': 'fas fa-microphone', 'action': 'shortcut'},
                {'text': 'Ctrl+/ - Show commands', 'icon': 'fas fa-keyboard', 'action': 'shortcut'},
                {'text': 'Esc - Close search', 'icon': 'fas fa-keyboard', 'action': 'shortcut'},
                {'text': 'Enter - Select suggestion', 'icon': 'fas fa-keyboard', 'action': 'shortcut'},
                {'text': '↑↓ - Navigate suggestions', 'icon': 'fas fa-keyboard', 'action': 'shortcut'}
            ]
        }
    
    @staticmethod
    def get_enhanced_knowledge():
        """Enhanced knowledge base for frontend"""
        return {
    ...
    @staticmethod
    def get_enhanced_responses():
        """Enhanced responses for frontend"""
        return {
            'greeting': [
...
class VANIEAI:
    ...
    def __init__(self):
        ...
        # Initialize search suggestions and enhanced knowledge
        self.search_suggestions_data = VANIEKnowledgeBase.get_search_suggestions_data()
        self.enhanced_knowledge = VANIEKnowledgeBase.get_enhanced_knowledge()
        self.enhanced_responses = VANIEKnowledgeBase.get_enhanced_responses()
...
if __name__ == '__main__':
    ...
    # Methods for Frontend Data Access
    def get_search_suggestions_data(self):
        return self.search_suggestions_data
    
    def get_enhanced_knowledge(self):
        return self.enhanced_knowledge
    
    def get_enhanced_responses(self):
        return self.enhanced_responses
